...
s1.addEventListener("mouseenter", function(){
    ...
    let r = Math.floor(Math.random()*100);// random number generate karega 
...
main.addEventListener("mousemove", function(md){
    crsr.style.left = md.x+ "px";
    crsr.style.top=md.y +"px";
})